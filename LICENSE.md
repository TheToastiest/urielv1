...
Reverse engineer, decompile, disassemble, or otherwise attempt to derive the source code, algorithms, or data structures of the Software, except to the extent expressly permitted by applicable law.

4. Confidentiality

If provided access to the Software, you agree to treat it as confidential and to implement reasonable security measures to prevent unauthorized access, use, or disclosure.
